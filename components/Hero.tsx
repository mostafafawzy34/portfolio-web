...
const techLogos = [
  ...
  {
    name: "Next.js",
    color: "from-slate-700/30 to-slate-900/30 text-white border-slate-700/50",
  },
  {
    name: "Node.js",
    color:
  ...
  },
  {
    name: "Python",
    color:
      "from-amber-500/20 to-yellow-600/20 text-amber-400 border-amber-500/30",
  },
  {
    name: "ESP32",
    color:
...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative pt-20 sm:pt-28 pb-12 sm:pb-16 px-4 sm:px-6 max-w-7xl mx-auto z-10 selection:bg-purple-500/30"
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
        ...
        <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-left order-2 lg:order-1">
          ...
          >
            I specialize in scalable full-stack web applications, ML
            microservices, Flutter cross-platform mobile apps, and custom
            embedded systems like ESP32 robotics.
          </motion.p>
          ...
          >
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 border border-[#262a4d] bg-[#121528]/80 hover:bg-[#181c35] text-slate-300 hover:text-white font-medium px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl transition-all text-xs sm:text-sm active:scale-95"
            >
          ...
          >
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {techLogos.map((tech) => (
                <div
                  key={tech.name}
                  className={`px-2.5 py-1 rounded-lg border bg-gradient-to-r ${tech.color} text-[11px] font-mono font-medium backdrop-blur-md`}
                >
                  {tech.name}
                </div>
              ))}
